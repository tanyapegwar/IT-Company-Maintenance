...
public class LoginManager extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(login, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 230, -1, -1));
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/it/dto/source.gif"))); // NOI18N
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 20, 480, 480));
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
      ...
      String username=jTextField1.getText();
        ...
        Transaction tran=sess.beginTransaction();
            ...
            crit.add(Restrictions.and(Restrictions.eq("managerUsername",username),Restrictions.eq("managerPassword",password)));
            ...
            if(list.isEmpty())
            {
                          ...
                          else
                          {
                              ...
                              HomepageManager mh=new HomepageManager();
                              mh.setVisible(true);
                              this.dispose();
                          }                                              
