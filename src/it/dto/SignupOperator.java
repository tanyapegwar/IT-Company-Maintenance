...
public class SignupOperator extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("CREATE NEW ACCOUNT(OPERATOR)");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 10, 370, 20));
        ...
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 110, 70, -1));
        ...
        jPanel1.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 190, 150, 30));

        jLabel5.setFont(new java.awt.Font("MS Reference Sans Serif", 1, 12)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Contact No.");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 150, 90, 30));
        ...
        jPanel1.add(jRadioButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 240, -1, -1));

        buttonGroup1.add(jRadioButton2);
        jRadioButton2.setText("Male");
        jPanel1.add(jRadioButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 240, -1, -1));
        ...
        jPanel1.add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 100, 150, 30));
        ...
        jPanel1.add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 150, 150, 30));
        ...
        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/it/dto/123.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      User user=new User(username,department,email,contactno,city,gender,password);
      session.save(user);
      tx.commit();
      session.close();
    ...
    LoginOperator lo=new LoginOperator();
        lo.setVisible(true);
        this.dispose();
