...
public class LoginOperator extends javax.swing.JFrame {
   ...
   static String username;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("OPERATOR SIGN IN");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 80, -1, -1));
        ...
        getContentPane().add(createAccount, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 230, -1, -1));
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/it/dto/1403050219582184712038186.gif"))); // NOI18N
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 80, 470, 350));

        jLabel6.setFont(new java.awt.Font("MS Reference Sans Serif", 1, 24)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("IT MAINTENANCE COMPANY");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 20, 400, 30));
        ...
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 200, 90, 90));
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
       ...
       username=jTextField1.getText();
        ...
        Transaction tran=sess.beginTransaction();
            ...
            Criteria crit=sess.createCriteria(Login.class);
            crit.add(Restrictions.and(Restrictions.eq("operatorUsername",username),Restrictions.eq("operatorPassword",password)));
                         ...
                         jPasswordField1.setText("");
                          ...
                          else
                          {
                             // JOptionPane.showMessageDialog(this,"WELCOME");
                              HomepageOperator mh=new HomepageOperator();
                              mh.setVisible(true);
                              this.dispose();
                          }
    ...
    private void createAccountActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createAccountActionPerformed
        // TODO add your handling code here:
    SignupOperator suo =new SignupOperator();
    suo.setVisible(true);
    this.dispose();
